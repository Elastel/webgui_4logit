<?php ob_start() ?>
  <?php if (!RASPI_MONITOR_ENABLED) : ?>
      <div class="cbi-page-actions">
        <input type="submit" class="btn btn-outline btn-primary" value="<?php echo _("Save settings"); ?>" name="savemcsettings" />
        <input type="submit" class="btn btn-success" value="<?php echo _("Apply settings"); $msg=_("Restarting dct"); ?>" data-toggle="modal" data-target="#hostapdModal" name="applymcsettings" />
      </div>
  <?php endif ?>
  <!-- Modal -->
      ...
      <div class="card-body">
          ...
          <?php echo CSRFTokenFieldTag() ?>       
            <div class="cbi-section cbi-tblsection" id="page_mc" name="page_mc">
              <table class="table cbi-section-table" name="table_mc" id="table_mc">
                <tr class="tr cbi-section-table-titles">
                  ...
                  <th class="th cbi-section-table-cell"><?php echo _("Data Area"); ?></th>
                ...
                <tr class="tr cbi-section-table-descr">
                  ...
                  <th class="th cbi-section-table-cell" ></th>
                  <th class="th cbi-section-table-cell" >000000~00FFFF</th>
                  <th class="th cbi-section-table-cell" >0001~0120</th>
                  <th class="th cbi-section-table-cell" ></th>
...
<div id="popBox" style="overflow:auto">
  ...
  <div class="cbi-section">
    ...
    <div class="cbi-value">
      ...
      <?php
        ...
        $tcp_proto = "4";
      ?>
      <?php if ($com1_enable[0] == "1" && $com1_proto[0] == $com_proto) { ?>
        <option value="COM1">COM1</option>
      <?php } ?>
      <?php if ($com2_enable[0] == "1" && $com2_proto[0] == $com_proto) { ?>
        <option value="COM2">COM2</option>
      <?php } ?>
      <?php if ($com3_enable[0] == "1" && $com3_proto[0] == $com_proto) { ?>
        <option value="COM3">COM3</option>
      <?php } ?>
      <?php if ($com4_enable[0] == "1" && $com4_proto[0] == $com_proto) { ?>
        <option value="COM4">COM4</option>
      <?php } ?>  
      <?php if ($tcp1_enable[0] == "1" && $tcp1_proto[0] == $tcp_proto) { ?>
        <option value="TCP1">TCP1</option>
      <?php } ?>
      <?php if ($tcp2_enable[0] == "1" && $tcp2_proto[0] == $tcp_proto) { ?>
        <option value="TCP2">TCP2</option>
      <?php } ?>
      <?php if ($tcp3_enable[0] == "1" && $tcp3_proto[0] == $tcp_proto) { ?>
        <option value="TCP3">TCP3</option>
      <?php } ?>
      <?php if ($tcp4_enable[0] == "1" && $tcp4_proto[0] == $tcp_proto) { ?>
        <option value="TCP4">TCP4</option>
      <?php } ?>
      <?php if ($tcp5_enable[0] == "1" && $tcp5_proto[0] == $tcp_proto) { ?>
        <option value="TCP5">TCP5</option>
      <?php } ?>

      <?php if (($com1_enable[0] == null || $com1_enable[0]  == "0"  || $com1_proto[0] != $com_proto) &&
    ...
    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.data_area"><?php echo _("Data Area"); ?></label>
      <select id="widget.data_area" class="cbi-input-select">
    ...
    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.start_addr"><?php echo _("Start Address"); ?></label>
      <input id="widget.start_addr" type="text" class="cbi-input-text">
      <label class="cbi-value-description">000000~00FFFF</label>
    </div>
    ...
    <div class="cbi-value">
      ...
      <label class="cbi-value-description">0001~0120</label>
    </div>
  ...
  <div class="right">
    ...
    <button class="cbi-button cbi-button-positive important" onclick="saveMcData()"><?php echo _("Save"); ?></button>
  </div>
</div><!-- popBox -->
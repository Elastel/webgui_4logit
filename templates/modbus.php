<?php ob_start() ?>
  <?php if (!RASPI_MONITOR_ENABLED) : ?>
      <div class="cbi-page-actions">
        <input type="submit" class="btn btn-outline btn-primary" value="<?php echo _("Save settings"); ?>" name="savemodbussettings" />
        <input type="submit" class="btn btn-success" value="<?php echo _("Apply settings"); $msg=_("Restarting dct"); ?>" data-toggle="modal" data-target="#hostapdModal" name="applymodbussettings" />
      </div>
  <?php endif ?>
  <!-- Modal -->
              ...
              <div class="cbi-section cbi-tblsection" id="page_modbus" name="page_modbus">
                <table class="table cbi-section-table" name="table_modbus" id="table_modbus">
                  <tr class="tr cbi-section-table-titles">
                    ...
                    <th class="th cbi-section-table-cell"><?php echo _("Device ID"); ?></th>
                    <th class="th cbi-section-table-cell"><?php echo _("Function Code"); ?></th>
                    <th class="th cbi-section-table-cell"><?php echo _("Start Address"); ?></th>
                  ...
                  <tr class="tr cbi-section-table-descr">
                    ...
                    <th class="th cbi-section-table-cell" >0~255</th>
                    <th class="th cbi-section-table-cell" >0~255</th>
                    <th class="th cbi-section-table-cell" >0~65535</th>
                    <th class="th cbi-section-table-cell" >1~120</th>
                    <th class="th cbi-section-table-cell" ><?php echo _("A highest byte"); ?></th>
...
<div id="popBox" style="overflow:auto">
  ...
  <div class="cbi-section">
    ...
    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.device_id"><?php echo _("Device ID"); ?></label>
      <input id="widget.device_id" type="text" class="cbi-input-text">
      <label class="cbi-value-description">0~255</label>
    </div>

    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.function_code"><?php echo _("Function Code"); ?></label>
      <input id="widget.function_code" type="text" class="cbi-input-text">
      <label class="cbi-value-description">0~255</label>
    </div>

    <div class="cbi-value">
      <label class="cbi-value-title" for="widget.reg_addr"><?php echo _("Start Address"); ?></label>
      <input id="widget.reg_addr" type="text" class="cbi-input-text">
      <label class="cbi-value-description">0~65535</label>
    </div>
    ...
    <div class="cbi-value">
      ...
      <select id="widget.data_type" class="cbi-input-select">
        <option value="0">Unsigned 16Bits AB</option>
        <option value="1">Unsigned 16Bits BA</option>
        <option value="2">Signed 16Bits AB</option>
        <option value="3">Signed 16Bits BA</option>
        <option value="4">Unsigned 32Bits ABCD</option>
        <option value="5">Unsigned 32Bits BADC</option>
        <option value="6">Unsigned 32Bits CDAB</option>
        <option value="7">Unsigned 32Bits DCBA</option>
        <option value="8">Signed 32Bits ABCD</option>
        <option value="9">Signed 32Bits BADC</option>
        <option value="10">Signed 32Bits CDAB</option>
        <option value="11">Signed 32Bits DCBA</option>
        <option value="12">Float ABCD</option>
        <option value="13">Float BADC</option>
        <option value="14">Float CDAB</option>
        <option value="15">Float DCBA</option>
      </select>
      <label class="cbi-value-description"><?php echo _("A highest byte"); ?></label>
    </div>
  ...
  <div class="right">
    ...
    <button class="cbi-button cbi-button-positive important" onclick="saveData()"><?php echo _("Save"); ?></button>
  </div>
</div><!-- popBox -->
